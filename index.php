...
if (isset($_POST['btn_login'])) {
  ...
  $select = $pdo->prepare("select * from User where useremail='$useremail' AND userpassword='$password'");
  $select->execute();
        ...
        <div class="row pt-2">
          <div class="col-6 offset-3">
            <button type="submit" class="btn btn-primary btn-block" name="btn_login"
                    style="background-color:<?php echo primary_color ?>;">Login
            </button>
          </div>
          <!-- /.col -->
        </div>
