...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="pos.php" class="brand-link">
      <img src="../images/logo_.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8; margin-top: 1px; margin-left: 3px">
      <span class="brand-text " style="padding-left: 18px; font-size: 25px"><?php echo TITLE ?> </span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="currentstock.php" class="nav-link">
