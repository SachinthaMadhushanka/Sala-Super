...
// 4 Step) If values will match then we will run update Query.
      ...
      $update = $pdo->prepare("update User set userpassword=:pass where useremail=:email");
            ...
            <form class="form-horizontal" action="" method="post">
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="password" class="form-control" id="inputPassword3" placeholder="Repeate New Password"
